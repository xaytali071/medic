...
abstract class GMedicalStyle {
  GMedicalStyle._();

  /// ###################### Colors ##########################
  ///
  static const primary = Color(0xff518CFF);

  //Secondary
  static const secondary = Color(0xff54C1FB);
  ...
  static const secondary200 = Color(0x7054C1FB);
  static const secondary100 = Color(0x5054C1FB);

  //Alert & Status
  static const success = Color(0xff4ADE80);
  static const selfActive = Color.fromRGBO(65, 203, 0, 1);
  static const info = Color(0xff246BFD);
  static const infoSelf = Color(0xff518CFF);
  ...
  static const avatar = Color(0xffF0EFF1);
  static const greyscale800 = Color(0xff424242);
  static const greyscale700 = Color(0xffA7AFBC);
  ...
  static const search = Color(0xffF9FBFF);
  ...
  static const blueCategory = Color(0xff45A4FF);
  static const grey = Color(0xff878787);
  static const lightGrey = Color(0xff36596A);
  static const transparent = Colors.transparent;
  static Color shimmerBase = Colors.grey.shade300;
  static Color shadow = const Color(0xff04060F).withOpacity(0.03);
  ...
  static List<BoxShadow> boxShadow = [
    BoxShadow(color: shadow, offset: const Offset(0, 3), blurRadius: 60.r)
  ];

  static ButtonStyle buttonStyle = ButtonStyle(
    overlayColor: MaterialStateProperty.all(GMedicalStyle.primary.withOpacity(0.1)),
  );
  ...
  static urbanistBold({
    double size = 18,
    Color color = GMedicalStyle.greyscale900,
  ...
  static List<Color> colorsList = [
    GMedicalStyle.blue,
    GMedicalStyle.buttonDisable,
    GMedicalStyle.secondary400,
  ];
}
