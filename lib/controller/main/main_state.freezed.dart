...
abstract class $MainStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool isLoading, int selectIndex});
}
...
class _$_MainState implements _MainState {
  const _$_MainState({this.isLoading = false, this.selectIndex = 0});
  ...
  @override
  String toString() {
    return 'MainState(isLoading: $isLoading, selectIndex: $selectIndex)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, isLoading, selectIndex);
...
abstract class _MainState implements MainState {
  const factory _MainState({final bool isLoading, final int selectIndex}) =
      _$_MainState;
